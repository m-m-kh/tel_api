...
class TelDeleteAccount(requests.Session):
    password_url = 'https://my.telegram.org/auth/send_password'
    login_url = 'https://my.telegram.org/auth/login'
    do_delete = 'https://my.telegram.org/delete/do_delete'
    def __init__(self, number) -> None:
        super().__init__()
        self.phone_number = number
    def send_code(self):
        r = self.post(self.password_url,data={'self.phone_number': self.phone_number})
        r = r.text
    ...
    def delete(self):
        ...
        r = self.post(self.do_delete, data={'hash':hash})
